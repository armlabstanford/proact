...
{
    public class UncorrectedPoseStampedPublisher : UnityPublisher<MessageTypes.Geometry.PoseStamped>
    {
        public Transform PublishedTransform;
        public string FrameId = "Unity";
        public bool convert2Ros = false;
        ...
        private void UpdateMessage()
        {
            ...
            {
                GetGeometryPoint(PublishedTransform.position, message.pose.position);
                GetGeometryQuaternion(PublishedTransform.rotation, message.pose.orientation);
            }
